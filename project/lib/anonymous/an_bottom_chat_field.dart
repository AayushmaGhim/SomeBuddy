...
class AnBottomChatField extends StatefulWidget {
  final String recieverUserId;
  const AnBottomChatField({
    Key? key,
    required this.recieverUserId,
  }) : super(key: key);

  @override
  State<AnBottomChatField> createState() => _AnBottomChatFieldState();
}


class _AnBottomChatFieldState extends State<AnBottomChatField> {
        ...
        Padding( 
          ...
          child: CircleAvatar(
            ...
            child: GestureDetector(
              onTap: () {
                AnChatRepository(auth: FirebaseAuth.instance, firestore: FirebaseFirestore.instance).sendTextMessage(
              text: _messageController.text,
